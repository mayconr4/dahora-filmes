...
export default function Favoritos() {
  ...
  const itemDaListaDeFavoritos = ({ item }: ItemDaListaDeFavoritosProps) => (
    ...
    >
      ...
      <Pressable
        ...
        // A chamar uma função (no caso, removeFilme) que necessite de parêmtros (nocaso, item.id), obrigatotriamente, a pro de evnto (onPress) deve usar a sintaxe com arrow function
  ...
  const removerFilme = async (id: number) => {
    try {
      ...
      // Carregamos novamente a lista de filme (já sem o filme excluído)
  ...
  const apagarTudo = () => {
    Alert.alert(
      ...
      "Tem certeza que deseja apgar todos os filmes favoritos?"
    );
  };
